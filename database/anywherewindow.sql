...
(1, 'Kerala Package', 'Kochi, Munnar, Alleppey, Thiruvananthapuram, Thrissur.', 10, 40000.00, 'Kerala'),
(2, 'Goa Package', 'Panaji, Old Goa, Margao, Vasco da Gama, Mapusa.', 7, 30000.00, 'Goa'),
(3, 'Tamil Nadu Package', 'Chennai, Madurai, Mahabalipuram, Ooty, Thanjavur.', 11, 37000.00, 'Tamil Nadu'),
(4, 'Karnataka Package', 'Bangalore, Mysore, Hampi, Badami, Mangalore.', 10, 35000.00, 'Karnataka'),
(5, 'Gujarat Package', 'Champaner, Rann of Kutch, Dwarka, Gir Forest, Ahmedabad.', 6, 25000.00, 'Gujarat'),
(6, 'Maharashtra Package', 'Aurangabad, Mahabaleshwar, Lonavala, Matheran, Mumbai.', 9, 42000.00, 'Maharashtra');
